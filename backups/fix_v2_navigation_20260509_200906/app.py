...
<div class="v2-bottom-nav">
    <a href="?tab=today" target="_self"><span class="emoji">🏠</span><span>Сегодня</span></a>
    <a href="?tab=fridge" target="_self"><span class="emoji">🧊</span><span>Холод.</span></a>
    <a href="?tab=scan" target="_self"><span class="emoji">📸</span><span>Сканер</span></a>
    <a href="?tab=recipes" target="_self"><span class="emoji">🍳</span><span>Рецепты</span></a>
    <a href="?tab=shopping" target="_self"><span class="emoji">🛒</span><span>Покупки</span></a>
</div>
""",
        unsafe_allow_html=True,
    )
...
def render_sidebar():
    with st.sidebar:
        ...
        page_labels = list(labels.values())
        ...
        selected = st.radio(
            ...
            page_labels,
            index=index,
            key="v2_sidebar_navigation",
        )

        st.session_state["tab"] = page_keys[page_labels.index(selected)]
