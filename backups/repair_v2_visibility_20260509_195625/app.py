...
from modern_ui_v13 import apply_modern_ui_v13, render_v13_clean_fast_screen
from qa_visual_fix_v13 import apply_qa_visual_fix_v13
from ui_polish_v13_1 import apply_ui_polish_v13_1
from mobile_nav_v13 import apply_modern_sidebar_and_mobile_nav_v13, process_mobile_nav_v13, render_bottom_mobile_nav_v13
from v2_foundation import render_v2_app, process_v2_query_navigation, apply_v2_design
apply_qa_visual_fix_v13()

apply_ui_polish_v13_1()
...
if page == "Быстрый экран":
    render_v13_clean_fast_screen()
elif page in ("📸 Фото и сканер", "Фото и сканер", "📸"):
    render_media_page()

elif page in ("🌟 Новый интерфейс v2", "Новый интерфейс v2", "v2"):
